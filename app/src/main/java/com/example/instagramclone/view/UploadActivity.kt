...
class UploadActivity : AppCompatActivity() {
    ...
    fun saveImageClicked(view : View){
    ...
    fun saveButtonClicked(view : View){
        ...
        if(selectedPicture != null){
            imageReference.putFile(selectedPicture!!).addOnSuccessListener {
                ...
                val uploadImagesReference = storage.reference.child("images").child(imageName)
                uploadImagesReference.downloadUrl.addOnSuccessListener {
